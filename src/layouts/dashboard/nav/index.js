    ...
    <Scrollbar
      sx={{
        ...
        '& .simplebar-content': {
          ...
          // backgroundColor: '#F4F5F7', // Background color for the content area
          // color: '#2D2D2D', // Font color for content
        },
        '@media (max-width: 600px)': {
          // Mobile view adjustments
          // backgroundColor: '#2D2D2D', // Background color for the content area
          // color: '#cd2e3a',
        },
      }}
    >
      ...
      <Box sx={{ mb: 5, mx: 2.5, backgroundColor: 'white' }}>
        <Link underline="none">
          <StyledAccount>
            ...
            <Box sx={{ ml: 2 }}>
              <Typography variant="subtitle2" sx={{ color: '#cd2e3a' }}>
                Admin
              </Typography>
