    ...
    <>
      ...
      <MaterialReactTable
        ...
        renderTopToolbarCustomActions={() => (
          <Button style={{ backgroundColor: '#cd2e3a' }} onClick={() => setCreateModalOpen(true)} variant="contained">
            Create New Exercise
          </Button>
        )}
      />
  ...
  return (
    <Dialog open={open}>
      ...
      <DialogActions sx={{ p: '1.25rem' }}>
        ...
        <Button style={{ backgroundColor: '#cd2e3a' }} onClick={handleSubmit} variant="contained">
          Create New Exercise
        </Button>
      </DialogActions>
    </Dialog>
